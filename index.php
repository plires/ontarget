	...
	<section class="home">
		...
		<div class="bg_gris">
			...
			<section class="equipo">
				...
				<img class="img-fluid puntos_left" src="img/home/puntos.png" alt="puntos equipo">
				
				<div class="container">

					<div class="row">
						<div class="col-md-12">
							<h2>Conoce el equipo con el que vas a Planificar tu Futuro</h2>
						</div>

						<div class="col-sm-6 col-md-4">
							<div class="integrante">
								<img class="img-fluid" src="img/home/anselmi.jpg" alt="anselmi">
								<div class="content_integrante">
									<h4>Director Estratégico</h4>
									<p>con Adrian Anselmi</p>
								</div>
							</div>
						</div>
