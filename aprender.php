...
<head>
	...
	<meta name="description" content="Bienvenido al Método OnTarget, queremos alentarte a que te sumes a nuestro equipo. Porque somos como vos y estamos para ayudarte a proyectar aquello que querés ser.">
	<title>Ontarget - Que voy a aprender? | OnTarget</title>
		...
		<div class="bg_gris">
			...
			<section data-aos="fade-up" class="adrian container-fluid">
				<div class="container">
					...
					<div class="row">
						<div class="col-md-12">
							<h2>Acerca de Adrian Anselmi</h2>
						</div>
					</div>
